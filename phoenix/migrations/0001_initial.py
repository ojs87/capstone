# Generated by Django 3.1.6 on 2021-03-19 01:15
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tarkovquest', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='phoenix.tarkovquest')),
            ],
        ),
        migrations.AddField(
            model_name='tarkovitem',
            name='FIRquest',
            field=models.ManyToManyField(through='phoenix.TarkovItemQuest', to='phoenix.TarkovQuest'),
        ),
        migrations.CreateModel(
            name='User',
            fields=[
